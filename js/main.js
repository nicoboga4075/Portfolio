...
const appArticles = [
  {
	...
	date: "2025-05-05",
	tags: [{"Framework" : "#"}, {"Library" : "#"}, {"Package" : "#"}, {"Module" : "#"}]
  },
  {
    slug: "mcs",
    title :{
    ...
    date: "2024-12-23",
	tags: [{"MCS" : "https://gimelec.fr/wp-content/uploads/2025/03/GIMELEC-Cyber-OT-Livre-blanc-MCS-2025-web.pdf"}, {"CyberSecurity" : "https://cyber.gouv.fr/le-cyberdico"}, {"Vulnerability" : "https://www.cvedetails.com/vulnerability-list"}, {"REST" : "#"}, {"API" : "https://aws.amazon.com/fr/what-is/api"}, {"OAuth2" : "https://loan-truong.medium.com/le-protocole-oauth2-0-a845773bec21"}]
  },
  {
    slug: "presentation",
    title : {
    ...
    date: "2024-01-01",
	tags: [{"Software Engineer" : "https://blog.lewagon.com/fr/career/metier-software-engineer"}, {"Full Stack Developer" : "https://blog.lewagon.com/fr/career/metiers-tech-developpement-web-developpeur-full-stack"}, {"Paris" : "#"}, {"Lyon" : "#"}, {"ESILV" : "https://www.esilv.fr/ingenieur/classement"}, {"UQAC" : "https://www.uqac.ca/programme/3037-maitrise-en-informatique-professionnel"}]
  },
  {
    ...
    date: "2019-07-31",
	tags: [{"Web Agency" : "#"}, {"Digital Transformation" : "#"}, {"Project Management" : "#"}, {"Business Growth" : "#"}]
  },
  {
    ...
    date: "2019-07-03",
	tags: [{"Brand Naming" : "#" }, {"Business Growth" : "#"}, {"Trademark" : "#"}, {"Entrepreneurship" : "#"}]
  }
];
...
function scrollToNextHighlight() {
  ...
  $target.addClass('current-match')[0].scrollIntoView({ behavior: 'smooth', block: 'center' });
}
...
async function sendEmail(senderName, subject, message) {
	...
	if (!token) {
		...
		try {
			appGoogleToken.requestAccessToken({prompt: 'consent'});
